...
BillItem.create(bill_item_id: BillItem.bill_item_id, bill_item_description: "Room Type Bill", bill_item_rate: "2000", bill_item_quantity: "1", unit_of_measure_id: "1", bill_item_status: "20")
BillItem.create(bill_item_id: BillItem.bill_item_id, bill_item_description: "Room Type Bill", bill_item_rate: "5000", bill_item_quantity: "1", unit_of_measure_id: "2", bill_item_status: "20")
...
Status.create(status_id: "20", status_cluster_id: "6", status_description: "active")
Status.create(status_id: "21", status_cluster_id: "6", status_description: "inactive")
